...
Loop_GF_mul_add_N:
  ...
  LD1    {v20.2d, v21.2d, v22.2d, v23.2d}, [x2]
...
Loop_POLY_mul_add_N:
  ...
  LD1    {v16.2d, v17.2d, v18.2d, v19.2d}, [x2]
  ...
  LD1    {v16.2d, v17.2d, v18.2d, v19.2d}, [x3]
...
Loop_POLY_red_N:
  ...
  ST1    {v26.2d, v27.2d}, [x1], #32
  ST1    {v0.2d, v1.2d, v2.2d, v3.2d}, [x1], #64
  ST1    {v4.2d, v5.2d},   [x1], #32
