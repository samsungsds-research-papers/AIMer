...
#define AIMER_NUM_REPETITIONS       17                  // number of parallel repetitions (Tau)
#define AIMER_NUM_MPC_PARTIES       256                 // number of MPC parties (N)
#define AIMER_NUM_MPC_PARTIES_LOG2  8                   // log_2(N)
